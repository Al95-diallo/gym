        ...
        <ul class="nav navbar-top-links navbar-right pull-right">
            <li class="dropdown"> <a class="dropdown-toggle waves-effect waves-light" data-toggle="dropdown" href="#"><i class="icon-bell"></i>
                ...
                <ul class="dropdown-menu mailbox scale-up">
                    <li>
                        <div class="drop-title">Vous avez {{ $unreadNotifications }} nouveaux notifications</div>
                    </li>
                    <li>
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu dropdown-user scale-up">
                    <li><a href="{{ route('customer-app.profile.index') }}"><i class="ti-user"></i> Mon Profile</a></li>
