        ...
        <ul class="nav" id="side-menu">
            ...
            <li class="user-pro">
                ...
                <ul class="nav nav-second-level">
                    <li><a href="{{ route('customer-app.profile.index') }}"><i class="ti-user"></i> Mon Compte</a></li>
                    <li><a href="{{ route('customer-app.message.index') }}"><i class="ti-email"></i> Inbox</a></li>
                    <li><a href="{{ route('customer-app.logout') }}"><i class="fa fa-power-off"></i> Déconnexion</a></li>
                </ul>
            </li>
            ...
            <li><a href="javascript:;" class="waves-effect {{ $paymentMenu or '' }}"><i
                            class="fa {{ $gymSettings->currency->symbol }}"></i> <span class="hide-menu gap-payments"> Paiement <span
